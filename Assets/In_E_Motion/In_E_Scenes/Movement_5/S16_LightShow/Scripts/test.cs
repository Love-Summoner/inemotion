            ...
            if (canvas != null && textPrefab != null)
            {
               ...
               // Debug.Log("Random Number: " + 111);
                if (uiText != null)
                {
                    ...
                    //rectTransform.anchoredPosition = new Vector2(UnityEngine.Random.Range(-Screen.width / 7, Screen.width / 7), UnityEngine.Random.Range(-Screen.height / 7, Screen.height / 7));
